...
<html>
  <head>
    ...
    <link href="healthcareproduct.css" type="text/css" rel="stylesheet" />
    <!--Bootstrap cdn-->
      ...
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12 col-12 text-center text-white">
            <h2 class="my-md-3 site-title">PharmaEasy</h2>
          </div>
      ...
      <div class="container-fluid p-0 ">
        <nav class="navbar navbar-expand-lg  navbar-light bg-light">
          ...
          <div class="navbar-nav">
            <a href="cart.php" class="nav-item border   cart-plus">
...
<div id="product-grid">
  ...
  ?>
    <div class="product-item">
      <form method="post" action="medicine.php?action=add&pid=<?php echo $row["id"]; ?>">
