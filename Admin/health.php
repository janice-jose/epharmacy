    ...
    <header>
      ...
      <div class="sidebar" style="text-decoration:none;">
        <div class="sidebar-j">
            ...
            <a class="active" href="health.php">Healthcare Products</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h4 class="modal-title w-100 font-weight-bold"> Healthcare Products</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body mx-3">
                        <form method="post" action="add_health.php" class="form-horizontal" role="form" id="form-item">
                ...
                <?php
                    while($row=$result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a type="button" href="add_health.php?delete=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>   
                <?php endwhile; ?>         
                </table>
